...
part of 'challenge_search_provider.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$searchChallengesHash() => r'7c82fae9d8e6c30f7697025ff0a3a4174a14508c';
...
class SearchChallengesFamily
    extends Family<AsyncValue<List<SearchChallengeCard>>> {
  /// See also [searchChallenges].
...
class SearchChallengesProvider
    extends AutoDisposeFutureProvider<List<SearchChallengeCard>> {
  /// See also [searchChallenges].
  ...
  Override overrideWith(
    FutureOr<List<SearchChallengeCard>> Function(SearchChallengesRef provider)
    create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<List<SearchChallengeCard>> createElement() {
...
mixin SearchChallengesRef
    on AutoDisposeFutureProviderRef<List<SearchChallengeCard>> {
...
class _SearchChallengesProviderElement
    extends AutoDisposeFutureProviderElement<List<SearchChallengeCard>>
