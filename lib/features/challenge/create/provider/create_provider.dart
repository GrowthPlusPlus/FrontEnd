// 최초 작성자 : 강선욱
import 'package:haenaem/features/challenge/create/models/created_response.dart';
...
class ChallengeCreateNotifier extends _$ChallengeCreateNotifier {
  @override
  AsyncValue<CreatedResponse?> build() => const AsyncValue.data(null);

  Future<CreatedResponse?> create(Map<String, dynamic> data) async {
