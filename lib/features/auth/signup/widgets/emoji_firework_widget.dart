// 최초 작성자 : 김채영
// 코드 출처 : https://github.com/sm-amoled/flutter_sandbox/tree/EmojiFireworkAnimation/sandbox/lib
import 'dart:math';
...
class FireworkWidget extends StatefulWidget {
  ...
  final void Function(Key) notifyWidgetIsDisposed;
  final AssetImage emojiAsset;
...
class _FireworkWidgetState extends State<FireworkWidget>
  ...
  void initState() {
    ...
    emojiAnimationLifeTimeController = AnimationController(
      vsync: this,
      duration: _emojiLifetimeDuration,
    );
